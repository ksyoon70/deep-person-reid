...
# 1. 경로 및 설정
src_root = r"E:\SPB_Data\chardet\datasets\hr_images"
dst_root = r"D:\SPB_Data\deep-person-reid\Ocr\hReg"
categories_path = r"E:\SPB_Data\chardet\hregion_categories.txt"
...
def main():
    ...
    for region_name, items in data_collector.items():
        ...
        if copied_test_files:
            query_count = max(1, int(len(copied_test_files) * 0.15))
